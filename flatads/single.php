				...
				<table class="ad-detail-half-box">
					<tr>
						<td class="centered-ad-details" style="text-align: center;">
							...
							<span class="ad-detail-info">
								<span class="author-profile-ad-details"><a href="<?php echo get_author_posts_url( get_the_author_meta( 'ID' ) ); ?>" class="button-ag large green"><span class="button-inner"><i class="fa fa-user"></i><?php _e( 'Author Profile', 'agrg' ); ?></span></a></span>
							</span>
