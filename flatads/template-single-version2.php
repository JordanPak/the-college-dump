	    	...
	    	<div class="span8 first">
	    		...
	    		<h2><?php the_title(); ?>
        			<?php global $current_user; get_currentuserinfo(); 
          			...
          			<?php } ?> - <span class="ad-page-price"><?php $post_price = get_post_meta($post->ID, 'post_price', true); echo $post_price; ?></span></h2>
	    		...
	    		<div id="galleria">
	    			<?php require_once(TEMPLATEPATH . '/inc/BFI_Thumb.php'); ?>
						...
						$params = array( 'width' => 630, 'height' => 371, 'crop' => true );
						...
						foreach($attachments as $att_id => $attachment) {
							...
							echo "<a href='" . bfi_thumb( "$full_img_url", $params ) . "''><img src='" . bfi_thumb( $full_img_url, $params_small ) . "', data-big='" . $full_img_url . "'' ></a>";
		    	...
		    	<div class="ad-detail-sidebar">
		    		...
		    		<div class="full">
						...
						<div class="full" style="margin-bottom: 20px;">
							...
							?>
									<span class="ad-detail-info"> 
					    				<i class="fa fa-phone-square"></i> <span class="ad-details"><span class="short-phone-number"><?php echo substr($wpcrown_author_phone, 0, 5);?>...</span><span class="long-phone-number"><?php echo $wpcrown_author_phone; ?></span><span class="show-long-number-button">View number</span></span>
									</span>
							<?php
								} 		
							?>
						...
						<div id="contact-ad-owner-v2">
							...
							<form name="contactForm" action="<?php the_permalink(); ?>" id="contact-form" method="post" class="contactform" >
								...
								<p><?php _e("Human test. Please input the result of 5+3=?", "agrg"); ?></p>
