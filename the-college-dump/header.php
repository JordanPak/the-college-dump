...
<body <?php if($layout == 2){ ?>id="boxed" <?php } ?> <?php body_class(); ?>>
	...
	<header id="navbar">
		...
		<div class="container">
            ...
            <!-- TCD_CUSTOM : style="margin-top: 13px !important" -->
            <!-- TCD_CUSTOM : Put #new-post ahead of main menu -->
			<section id="new-post" class="block block-crystal-block" style="margin-top: 25px !important; float: right;">
					<?php 
						global $redux_demo; 
						$new_post = $redux_demo['new_post'];
					?>
                    
                    <!-- TCD_CUSTOM : Change 'Post your Ad' to 'Post your Item' -->
					<a href="<?php echo $new_post; ?>" class="btn button"><?php _e( 'Post your Item!', 'agrg' ); ?></a>
				</section> <!-- /.block -->
