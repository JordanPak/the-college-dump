				...
				<table class="ad-detail-half-box">
					<tr>
						<td class="centered-ad-details" style="text-align: center;">
                            ...
                            <?php /* DISABLED BECAUSE IT DOESN'T WORK! TCD_CUSTOM
							...
							<span class="ad-details-title"><h3><?php echo get_the_author_meta('display_name', $user_ID ); ?></h3></span>
							...
							?>
								<span class="ad-detail-info">
					    			<span class="ad-details"><?php echo $wpcrown_author_address; ?></span>
								</span>
							<?php
								} 		
							?>
							...
							?>
								<span class="ad-detail-info"> 
				    				<span class="ad-details"><?php echo $wpcrown_author_phone; ?></span>
								</span>
							<?php
								} 		
							?>

							<?php $curauth = get_user_by( 'id', get_queried_object()->post_author ); // get the info about the current author <-- THIS DOESN'T WORK!!! (TCD) ?>
                            ...
                            <span class="ad-detail-info">
                                <span class="ad-details"><a href="<?php echo $wpcrown_author_web; ?>"><?php echo $wpcrown_author_web; ?></a></span>
                            </span>
							...
							*/ ?>
							...
							<span class="ad-detail-info">
								<span class="author-profile-ad-details"><a href="<?php echo get_author_posts_url( get_the_author_meta( 'ID' ) ); ?>" class="button-ag large green"><span class="button-inner"><i class="fa fa-user"></i><?php _e( 'Seller Profile', 'agrg' ); // TCD_CUSTOM ?></span></a></span>
							</span>
					...
					<tr>
						<td>
							...
							<?php
								...
								if(!empty($wpcrown_custom_fields[0][0])) {

									for ($i = 0; $i < count($wpcrown_custom_fields); $i++) {

										if(!empty($wpcrown_custom_fields[$i][1])) {
				...
				<div class="full">
					...
					<div id="contact-ad-owner">
						...
						<form name="contactForm" action="<?php the_permalink(); ?>" id="contact-form" method="post" class="contactform" >
							...
							<p style="margin-top: 20px;"><?php /* TCD_CUSTOM */ _e("Quick, what's 5+3?", "agrg"); ?></p>
