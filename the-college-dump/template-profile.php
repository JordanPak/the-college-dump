        ...
        <div class="container">
        	...
        	<div class="full" style="margin-top: 20px;">
				...
				<div class="span3">
                    ...
                    <!-- TCD_CUSTOM : Change ads to items -->
					<span class="ad-detail-info"><?php _e( 'Regular Items', 'agrg' ); ?>
            ...
            <!-- TCD_CUSTOM : Remove "Premium Regular" -->
        	<h3><?php echo $user_identity; ?> <?php _e( ':Items', 'agrg' ); ?></h3>
